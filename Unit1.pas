...
begin
 /////// gl baþlangýç iþlemleri
// MO := TMeshObject.CreateOwned(GLFreeForm1.MeshObjects) ;
// MO.Mode := momFaceGroups;
// FG := TFGVertexNormalTexIndexList.CreateOwned(MO.FaceGroups);
// FG.Mode := fgmmTriangles;

// MO.Vertices.Add(-100.0,-100.0,-100.0); //
//    MO.Vertices.Add(-100.0,-100.0, 100.0); //
//    MO.Vertices.Add(-100.0, 100.0, -100.0); //
//
//    MO.Normals.Add(0, 0, 1);
//
//    FG.VertexIndices.Add(0, 1, 2);//bir yüzey için
//    FG.NormalIndices.Add(0, 0, 0);  //bir normal için
 ...
 while not Eof(txtDosyam) do
  begin
    ...
    List2.DelimitedText := form1.Label1.Caption;
  end;
  ShowMessage(text);
  CloseFile(txtDosyam);
end;
